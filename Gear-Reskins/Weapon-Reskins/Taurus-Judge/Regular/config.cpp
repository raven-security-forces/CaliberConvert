class CfgPatches
{
	class rsf_reskin_taurus
	{
		...
		units[]=
		{
			"Weapon_hgun_Pistol_Signal_lethal_F"
		};
		weapons[]=
		{
...
{
	class Weapon_Base_F;
	class Weapon_hgun_Pistol_Signal_lethal_F: Weapon_Base_F
	{
		scope=2;
		scopeCurator=2;
...
class CfgWeapons
{
	...
	class hgun_Pistol_Signal_lethal_F: hgun_Pistol_heavy_02_F
	{
		...
		{
		"\Gear-Reskins\Weapon-Reskins\Taurus-Judge\Regular\Data\Pistol_Signal_01_lethal_2_CO.paa",
		};
