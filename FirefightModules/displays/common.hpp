...
class cba_settings_ButtonConfigure_base: RscButtonMenu
{
	...
	x = ((11.1) * (GUI_GRID_WAbs/ 40)+ GUI_GRID_X);
	y = ((23) * ((GUI_GRID_WAbs/ 1.2)/ 25)+ (safezoneY + safezoneH - (((safezoneW / safezoneH) min 1.2)/ 1.2)));
	w = ((10) * (GUI_GRID_WAbs/ 40));
	h = ((1) * ((GUI_GRID_WAbs/ 1.2)/ 25));
};
class cba_settings_OptionsGroup: RscControlsGroupNoHScrollbars
{
	x = ((0) * (GUI_GRID_WAbs/ 40));
	y = ((3.5) * ((GUI_GRID_WAbs/ 1.2)/ 25));
	w = ((37.5) * (GUI_GRID_WAbs/ 40));
	h = ((13.8) * ((GUI_GRID_WAbs/ 1.2)/ 25));
	lineHeight = ((1) * ((GUI_GRID_WAbs/ 1.2)/ 25));
};
class cba_settings_AddonsList: RscCombo
{
	linespacing = 1;
	text = "";
	wholeHeight = ((12) * ((GUI_GRID_WAbs/ 1.2)/ 25));
	x = ((4.5) * (GUI_GRID_WAbs/ 40));
	y = ((1) * ((GUI_GRID_WAbs/ 1.2)/ 25));
	w = ((21) * (GUI_GRID_WAbs/ 40));
	h = ((1) * ((GUI_GRID_WAbs/ 1.2)/ 25));
};
...
{
	cba_settings_script = "";
	x = ((1) * (GUI_GRID_WAbs/ 40));
	y = ((0) * ((GUI_GRID_WAbs/ 1.2)/ 25));
	w = ((37) * (GUI_GRID_WAbs/ 40));
	h = ((0) * ((GUI_GRID_WAbs/ 1.2)/ 25));
};
class cba_diagnostic_watchInput: RscEdit
{
	...
	x = 0.5 * (GUI_GRID_WAbs/ 40);
	y = 11 * ((GUI_GRID_WAbs/ 1.2)/ 25);
	w = 21 * (GUI_GRID_WAbs/ 40);
	h = 1 * ((GUI_GRID_WAbs/ 1.2)/ 25);
	sizeEx = 0.7 * ((GUI_GRID_WAbs/ 1.2)/ 25);
};
