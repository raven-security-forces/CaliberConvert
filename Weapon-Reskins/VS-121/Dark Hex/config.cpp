...
class CfgWeapons
{
	...
	class srifle_DMR_01_dhex_F: srifle_DMR_01_F
	{
		...
		author="NeroTheHero111";
		displayName="VS-121 (Dark Hex)";
		picture="\Weapon-Reskins\VS-121\Dark Hex\UI\icon_dmr_01_dark.paa";
		hiddenSelections[] = 
		{
			"camo1",
			"camo2"
		...
		{
		"\Weapon-Reskins\VS-121\Dark Hex\Data\dmr_01_dark_2_co.paa",
		"\Weapon-Reskins\VS-121\Dark Hex\Data\dmr_02_dark_2_co.paa"
		};
