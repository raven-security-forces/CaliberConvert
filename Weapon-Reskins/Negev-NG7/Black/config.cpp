...
class CfgWeapons
{
	...
	class LMG_Zafir_black_F: LMG_Zafir_F
	{
		...
		author="NeroTheHero111";
		displayName="Negev NG7 (Black)";
		picture="\Weapon-Reskins\Negev-NG7\Black\UI\icon_Zafir_black_CO.paa";
		hiddenSelections[] = 
		{
			"camo1",
			"camo2"
		...
		{
		"\Weapon-Reskins\Negev-NG7\Black\Data\Zafir01_black_CO.paa",
		"\Weapon-Reskins\Negev-NG7\Black\Data\Zafir02_black_CO.paa"
		};
