...
class CfgWeapons
{
	...
	class SMG_01_black_F: SMG_01_F
	{
		...
		author="NeroTheHero111";
		displayName="Vector SMG (Grey)";
		picture="\Weapon-Reskins\KRISS-Vector\Grey\UI\gear_SMG_01_X_black_CA.paa";
		hiddenSelections[] = 
		{
		"camo1","camo2","camo3"
		};
		...
		{
		"\Weapon-Reskins\KRISS-Vector\Grey\Data\SMG_01_black_co.paa",
		"\Weapon-Reskins\KRISS-Vector\Grey\Data\Vectoratt_black_co.paa",
