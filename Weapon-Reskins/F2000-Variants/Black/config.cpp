...
class CfgWeapons
{
	...
	class arifle_Mk20_Black_F: arifle_Mk20_plain_F
	{
		...
		author="NeroTheHero111";
		displayName="F2000 (Grey)";
		picture="\Weapon-Reskins\F2000-Variants\Black\UI\icon_mk20_co_black_std.paa";
		hiddenSelections[] = 
		{
			"camo"
		};
		...
		{
			"\Weapon-Reskins\F2000-Variants\Black\Data\mk20_co_black",
		};
	...
	class arifle_Mk20_Black_GL_F: arifle_Mk20_GL_plain_F
	{
		...
		author="NeroTheHero111";
		displayName="F2000 EGLM (Grey)";
		picture="\Weapon-Reskins\F2000-Variants\Black\UI\icon_mk20_co_black_eglm.paa";
		hiddenSelections[] = 
		{
			"camo",
			"camo2"
		...
		{
			"\Weapon-Reskins\F2000-Variants\Black\Data\mk20_co_black",
			"\Weapon-Reskins\F2000-Variants\Black\Data\mk20_utilities_CO_black.paa",
		};
	...
	class arifle_Mk20C_Black_F: arifle_Mk20C_plain_F
	{
		...
		author="NeroTheHero111";
		displayName="F2000 Tactical (Grey)";
		picture="\Weapon-Reskins\F2000-Variants\Black\UI\icon_mk20_co_black_c.paa";
		hiddenSelections[] = 
		{
			"camo"
		};
